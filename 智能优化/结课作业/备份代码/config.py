...
class Config:
    ...
    MODEL_TYPE = 'FNO'  # 模型类型: 'MLP' 或 'FNO' (Fourier Neural Operator)
    FNO_MODES = 8       # FNO模型保留的Fourier模式数
    ...
    ENABLE_HYBRID = True      # 是否启用 PSO + Gradient
    GRAD_STEPS = 400         # 梯度下降精调步数
    LEARNING_RATE = 0.008      # 梯度下降学习率
